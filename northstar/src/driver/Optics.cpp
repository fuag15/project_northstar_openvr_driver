...
northstar::driver::COptics::SEyeConfiguration northstar::driver::COptics::LoadConfigFromEye(const vr::EVREye& eEye) {
    ...
    sEyeConfiguration.sEllipsisAxis.dMajor = m_pVRSettings->GetFloat(sEyeKey.data(), eye::k_svEllipseMajorAxis.data());
    sEyeConfiguration.sEllipsisAxis.dMinor = m_pVRSettings->GetFloat(sEyeKey.data(), eye::k_svEllipseMinorAxis.data());
    sEyeConfiguration.v3dScreenForward =
        m_pVectorFactory->V3DFromArray(
            { m_pVRSettings->GetFloat(sEyeKey.data(), eye::k_svScreenForwardX.data())
            , m_pVRSettings->GetFloat(sEyeKey.data(), eye::k_svScreenForwardY.data())
            , m_pVRSettings->GetFloat(sEyeKey.data(), eye::k_svScreenForwardZ.data()) });

    sEyeConfiguration.v3dScreenPosition =
        m_pVectorFactory->V3DFromArray(
            { m_pVRSettings->GetFloat(sEyeKey.data(), eye::k_svScreenPositionX.data())
            , m_pVRSettings->GetFloat(sEyeKey.data(), eye::k_svScreenPositionY.data())
            , m_pVRSettings->GetFloat(sEyeKey.data(), eye::k_svScreenPositionZ.data()) });

    sEyeConfiguration.v3dEyePosition =
        m_pVectorFactory->V3DFromArray(
            { m_pVRSettings->GetFloat(sEyeKey.data(), eye::k_svEyePositionX.data())
            , m_pVRSettings->GetFloat(sEyeKey.data(), eye::k_svEyePositionY.data())
            , m_pVRSettings->GetFloat(sEyeKey.data(), eye::k_svEyePositionZ.data()) });

    sEyeConfiguration.qdEyeRotation =
        Quaterniond(
            m_pVRSettings->GetFloat(sEyeKey.data(), eye::k_svEyeRotationW.data()),
            m_pVRSettings->GetFloat(sEyeKey.data(), eye::k_svEyeRotationX.data()),
    ...
    sEyeConfiguration.m4dSphereToWorldSpace =
        m_pMatrixFactory->FromRowMajorArray(
            { m_pVRSettings->GetFloat(sEyeKey.data(), eye::k_svSphereToWorldSpace_00.data())
            , m_pVRSettings->GetFloat(sEyeKey.data(), eye::k_svSphereToWorldSpace_01.data())
            , m_pVRSettings->GetFloat(sEyeKey.data(), eye::k_svSphereToWorldSpace_02.data())
            , m_pVRSettings->GetFloat(sEyeKey.data(), eye::k_svSphereToWorldSpace_03.data())
            , m_pVRSettings->GetFloat(sEyeKey.data(), eye::k_svSphereToWorldSpace_10.data())
            , m_pVRSettings->GetFloat(sEyeKey.data(), eye::k_svSphereToWorldSpace_11.data())
            , m_pVRSettings->GetFloat(sEyeKey.data(), eye::k_svSphereToWorldSpace_12.data())
            , m_pVRSettings->GetFloat(sEyeKey.data(), eye::k_svSphereToWorldSpace_13.data())
            , m_pVRSettings->GetFloat(sEyeKey.data(), eye::k_svSphereToWorldSpace_20.data())
            , m_pVRSettings->GetFloat(sEyeKey.data(), eye::k_svSphereToWorldSpace_21.data())
            , m_pVRSettings->GetFloat(sEyeKey.data(), eye::k_svSphereToWorldSpace_22.data())
            , m_pVRSettings->GetFloat(sEyeKey.data(), eye::k_svSphereToWorldSpace_23.data())
            , 0, 0, 0, 1 });

    sEyeConfiguration.m4dWorldToScreenSpace =
        m_pMatrixFactory->FromRowMajorArray(
            { m_pVRSettings->GetFloat(sEyeKey.data(), eye::k_svWorldToScreenSpace_00.data())
            , m_pVRSettings->GetFloat(sEyeKey.data(), eye::k_svWorldToScreenSpace_01.data())
            , m_pVRSettings->GetFloat(sEyeKey.data(), eye::k_svWorldToScreenSpace_02.data())
            , m_pVRSettings->GetFloat(sEyeKey.data(), eye::k_svWorldToScreenSpace_03.data())
            , m_pVRSettings->GetFloat(sEyeKey.data(), eye::k_svWorldToScreenSpace_10.data())
            , m_pVRSettings->GetFloat(sEyeKey.data(), eye::k_svWorldToScreenSpace_11.data())
            , m_pVRSettings->GetFloat(sEyeKey.data(), eye::k_svWorldToScreenSpace_12.data())
            , m_pVRSettings->GetFloat(sEyeKey.data(), eye::k_svWorldToScreenSpace_13.data())
            , m_pVRSettings->GetFloat(sEyeKey.data(), eye::k_svWorldToScreenSpace_20.data())
            , m_pVRSettings->GetFloat(sEyeKey.data(), eye::k_svWorldToScreenSpace_21.data())
            , m_pVRSettings->GetFloat(sEyeKey.data(), eye::k_svWorldToScreenSpace_22.data())
            , m_pVRSettings->GetFloat(sEyeKey.data(), eye::k_svWorldToScreenSpace_23.data())
            , 0, 0, 0, 1 });
...
Vector2d northstar::driver::COptics::ReverseProjectEyeUVToDisplayUV(const vr::EVREye& eEye, const Vector2d& v2dEyeUV) {
    ...
    auto v3dSphereSpaceLensIntersection = ov3dSphereSpaceLensIntersection.value();
